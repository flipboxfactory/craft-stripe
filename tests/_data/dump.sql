...
INSERT INTO `plugins` (`id`, `handle`, `version`, `schemaVersion`, `licenseKeyStatus`, `licensedEdition`, `installDate`, `dateCreated`, `dateUpdated`, `uid`) VALUES (1,'stripe','1.0.0','1.2.0','unknown',NULL,'2019-05-23 12:57:21','2019-05-23 12:57:21','2019-05-23 12:57:23','bcca3576-df15-4b7a-86a1-d0983af4860b');
...
CREATE TABLE `stripe_connections` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `stripe_connections_handle_unq_idx` (`handle`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stripe_connections`
--

/*!40000 ALTER TABLE `stripe_connections` DISABLE KEYS */;
/*!40000 ALTER TABLE `stripe_connections` ENABLE KEYS */;

--
-- Table structure for table `stripe_objects`
--

DROP TABLE IF EXISTS `stripe_objects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stripe_objects` (
  ...
  KEY `stripe_objects_objectId_idx` (`objectId`),
  KEY `stripe_objects_siteId_fk` (`siteId`),
  KEY `stripe_objects_fieldId_fk` (`fieldId`),
  CONSTRAINT `stripe_objects_elementId_fk` FOREIGN KEY (`elementId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `stripe_objects_fieldId_fk` FOREIGN KEY (`fieldId`) REFERENCES `fields` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `stripe_objects_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stripe_objects`
--

/*!40000 ALTER TABLE `stripe_objects` DISABLE KEYS */;
/*!40000 ALTER TABLE `stripe_objects` ENABLE KEYS */;
